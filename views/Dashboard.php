    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            ...
            <div class="d-flex align-items-center text-white">
                ...
                <a href="index.php?action=edit_profile" class="btn btn-sm btn-outline-light me-2">Meu Perfil</a>
                <a href="index.php?action=logout" class="btn btn-sm btn-outline-danger">Sair</a>
            </div>
        </div>
    </nav>
        ...
        <div class="row mb-4">
            <div class="col-md-4">
                <div class="card text-white bg-primary shadow-sm h-100">
                    <div class="card-body">
                        <h6 class="card-title text-uppercase text-white-50">Total de Tarefas</h6>
                        <h2 class="display-6 mb-0"><?= $stats['total'] ?></h2>
                    </div>
                </div>
            </div>
            <div class="col-md-4 mt-3 mt-md-0">
                <div class="card text-dark bg-warning shadow-sm h-100">
                    <div class="card-body">
                        <h6 class="card-title text-uppercase opacity-75">Pendentes</h6>
                        <h2 class="display-6 mb-0"><?= $stats['pendente'] ?></h2>
                    </div>
                </div>
            </div>
            <div class="col-md-4 mt-3 mt-md-0">
                <div class="card text-white bg-success shadow-sm h-100">
                    <div class="card-body">
                        <h6 class="card-title text-uppercase text-white-50">Concluídas</h6>
                        <h2 class="display-6 mb-0"><?= $stats['concluida'] ?></h2>
                    </div>
                </div>
            </div>
        </div>
